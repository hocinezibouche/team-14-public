...
class _CreateTaskWidgetState extends State<CreateTaskWidget>
  ...
  void initState() {
    ...
    _model.taskhoursController ??= TextEditingController();
    _model.taskhoursFocusNode ??= FocusNode();
                            ...
                            children: [
                              ...
                              StreamBuilder<List<PlansRecord>>(
                                ...
                                builder: (context, snapshot) {
                                  ...
                                  return FlutterFlowDropDown<String>(
                                    ...
                                    hintText: 'Please select storage for task',
                                    icon: Icon(
                                  ...
                                  builder: (context, snapshot) {
                                    ...
                                    return FlutterFlowDropDown<String>(
                                      ...
                                      textStyle: FlutterFlowTheme.of(context)
                                          .bodyMedium,
                                      hintText:
                                          'Please select who is responsible for task',
                                      icon: Icon(
                                        Icons.keyboard_arrow_down_rounded,
                                        color: FlutterFlowTheme.of(context)
                                            .secondaryText,
                              ...
                              Padding(
                                padding: const EdgeInsetsDirectional.fromSTEB(
                                    0.0, 8.0, 0.0, 8.0),
                                child: TextFormField(
                                  controller: _model.taskhoursController,
                                  focusNode: _model.taskhoursFocusNode,
                                  autofocus: true,
                                  obscureText: false,
                                  decoration: InputDecoration(
                                    hintText: 'Task hours',
                                  ...
                                  validator: _model.taskhoursControllerValidator
                                      .asValidator(context),
                                ),
                              ),
                              Text(
