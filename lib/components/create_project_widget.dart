...
class _CreateProjectWidgetState extends State<CreateProjectWidget>
  ...
  void initState() {
    ...
    _model.projectHourController ??= TextEditingController();
    _model.projectHourFocusNode ??= FocusNode();
                            ...
                            children: [
                              ...
                              Padding(
                                padding: const EdgeInsetsDirectional.fromSTEB(
                                    0.0, 0.0, 0.0, 12.0),
                                child: TextFormField(
                                  controller: _model.projectHourController,
                                  focusNode: _model.projectHourFocusNode,
                                  autofocus: true,
                                  obscureText: false,
                                  decoration: InputDecoration(
                                    hintText: 'Project Hours',
                                    hintStyle: FlutterFlowTheme.of(context)
                                        .headlineMedium
                                        .override(
                                          fontFamily: 'Outfit',
                                  ...
                                  style:
                                      FlutterFlowTheme.of(context).labelLarge,
                                  validator: _model
                                      .projectHourControllerValidator
                                      .asValidator(context),
                                ),
                              ),
                              Text(
